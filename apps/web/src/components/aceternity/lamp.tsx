...
export function Lamp({ className, children }: LampProps) {
    return (
        <div
            className={cn(
                "relative flex min-h-[500px] flex-col items-center justify-center overflow-hidden rounded-3xl",
                className
            )}
        >
            {/* Lamp beam */}
            <div className="relative flex w-full flex-1 items-center justify-center">
                ...
                <div className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-primary-500 opacity-50 blur-3xl" />
